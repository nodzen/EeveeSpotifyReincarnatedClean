...
enum KaraokeTextAlignment: String, Codable, CaseIterable {
    ...
    var displayName: String {
        switch self {
        case .leading: return "karaoke_alignment_left".localized
        case .center: return "karaoke_alignment_center".localized
        case .trailing: return "karaoke_alignment_right".localized
        }
    }
}
